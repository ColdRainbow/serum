...
impl From<&solana_sdk::instruction::AccountMeta> for TransactionAccount {
    fn from(account_meta: &solana_sdk::instruction::AccountMeta) -> TransactionAccount {
        TransactionAccount {
            pubkey: account_meta.pubkey.to_bytes().into(),
            is_signer: account_meta.is_signer,
            is_writable: account_meta.is_writable,
        }
    }
